...
language_dictionary = {'En': {'information_prompt': 'IMPORTANT ISSUE!!!\nIf you want to leave any part of the program type 0 [zero] in your input!',
                              ...
                              'deleting_logs': "Do you want to delete previous script results? If yes type '1', if not type anything else:\n",
                              'print_logs': "This is a list of all saved script logs: ",
                              ...
                              'finish_conf': "Was this device the last one? Type '1' if yes, type anything else if not: ",
                              ...
                              'ver_dev': "Which device do you want to update? Type ID numbers divided by space from table above: ",
                              ...
                              'ie2000_wait': "Please wait about 3 minutes, because IE2000 is working a little bit slower...",
