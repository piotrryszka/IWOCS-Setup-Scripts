...
def check_license(udi, state_string, type_string, ipservices_string):
    # checking for IE4010
    if state_string == 'Active, In Use' and type_string == 'PermanentRightToUse' and ipservices_string == 'ipservices' and udi == 'IE-4010':
        ok_not = 'OK'
    if state_string == 'Active, In Use' and type_string == 'Permanent' and ipservices_string == 'iplite' and udi == 'IE-2000':
        ok_not = 'OK'
